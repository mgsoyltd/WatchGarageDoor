...
class ExtensionDelegate: NSObject, WKExtensionDelegate {
    ...
    func applicationWillResignActive() {
        ...
        NotificationCenter.default.post(name: .applicationIsDeactive, object: nil)
    }
...
extension Notification.Name {
    ...
    static var applicationIsDeactive: Notification.Name {
        Notification.Name("applicationIsDeactive")
    }
}
